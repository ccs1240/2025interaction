//week02_2
//把makeunodefaultsketch複製過來
///setup(34-40)for迴圈複製過來 創一個MYMUSIC()
#define NOTE_C5 523
#define NOTE_E5 659
#define NOTE_G5 784
...
{
  delay(1000);
  Serial.begin(9600);///在ARDUINO裡的seyup
...
void serialEvent(){///第六行負責USB的SERIAL的函數式
  while(Serial.available()){///第七如果USB有資料
    Serial.read();///第八行就讀進來
    mymusic();///順便MYMUSIC也進來
  }
}
void loop()
{
